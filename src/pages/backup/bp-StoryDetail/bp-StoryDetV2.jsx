...
function StoryDetail() {
    ...
    const handleDeleteEP = (episodeNumber) => {
        setDeleteEPModalIsOpen(true); // เปิด Modal สำหรับลบตอน
        setEpisodeToDelete(episodeNumber); // เซ็ต episodeNumber ที่ต้องการลบ
    };
                ...
                <div className="grid-container">
                    ...
                    {gridData.map((item, index) => (
                        <div className="grid-item-ep" key={index}>
                            ...
                            <button className="delete-button" onClick={() => handleDeleteEP(item.ep)}>Delete</button>
                        </div>
                    ...
                    <AlertDeleteEP
                        ...
                        handleDeleteEP={handleDeleteEP}
                        episodeNumber={episodeToDelete}
                    />
                </div>
            </div>
            <AddEPModal
